function getSPF(web_ip,source,target){
        console.log('this is the web_ip inside getSPF',web_ip)
	links_spf = []
	...
	//console.log(arrStr)
	url = 'http://'+web_ip+':8801/api/spf?'+'arr='+arrStr+'&'+'source='+source+'&'+'target='+target
